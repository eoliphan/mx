...
module.exports = function (app) {
  ...
  app.get('/api/albums/byuser/:id', function (req, res) {
  ...
  app.post('/api/album/:id', function (req, res) {
    ...
    albumUpdate.itemId = req.params.id;
    //albumUpdate[req.body.name] = req.body.value;
  ...
  /**
   * todo, should do this via mime type?
   */
  app.get('/album/song/:id/stream', function (req, res) {
    var itemId = req.params.id;
    var songStream = gfsfilestore.getStreamByName(itemId);
    if (!songStream) {
      res.send(404);
    } else {
      res.writeHead(200, {
